...
Use `src/`, `package.json`, and the deployment workflow as implementation truth. The root README is currently the generic Vite template and is not authoritative project documentation.
...
5. Prefer newer dated information, mention meaningful conflicts, and cite Second Brain source files for important conclusions.
6. Never copy project source code into the Second Brain.
7. When meaningful project changes are detected, suggest which Second Brain records should be updated; do not update them without user approval.
