...
# Define the callback function to enable/disable the year dropdown based on the selected report type
@app.callback(
...
# TASK 2.6: Combined callback for both Yearly and Recession Report Statistics
@app.callback(
...
def update_output_container(selected_statistics, input_year):
    ...
    # Recession Period Statistics plots
    if selected_statistics == 'Recession Period Statistics':
        ...
        # Return recession statistics graphs in a 2x2 layout
        return html.Div([
    ...
    # Yearly Statistics plots
        ...
        # Return yearly statistics graphs in a 2x2 layout
        return html.Div([
